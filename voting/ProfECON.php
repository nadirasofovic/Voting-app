...
<main>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO votes (candidate_id, position_id, vid) VALUES ('$selectedProfessor', 15, '$loggedInUser')";
    ...
    <form method="POST">
        ...
        <select name="professor" id="professor">
            ...
            $query = "SELECT cid, first_name, last_name FROM candidate WHERE positions = 15";
